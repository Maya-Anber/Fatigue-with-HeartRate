...
exports.HeartRateMonitorServerProxy = exports.HeartRateMonitor = void 0;
const ppg_processor_1 = require("./ppg-processor");
/**
...
class HeartRateMonitor {
    constructor(config = {}) {
        this.processor = new ppg_processor_1.PPGProcessor();
        this.stream = null;
        this.video = null;
        this.canvas = null;
        this.ctx = null;
...
exports.HeartRateMonitor = HeartRateMonitor;
/**
 ...
 */
class HeartRateMonitorServerProxy {
    constructor() {
        this.latestReading = null;
        this.listeners = [];
    }
...
exports.HeartRateMonitorServerProxy = HeartRateMonitorServerProxy;
